...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a href="{{url('/admin/mailtemplate')}}"><button class="btn btn-success btn-flat">Back</button></a>
    </div> 
</div>
@stop
...
<div class="box box-success color-palette-box">
    ...
    <div class="box-body">
        <?php $action = isset($data->id) ? 'admin/mailtemplate/update/'.Crypt::encryptString($data->id) : 'admin/mailtemplate/store'; ?>
       {{ Form::open(array('url' => $action,'id'=>'myForm','files'=>'true')) }}
        <div class="box-body">
            ...
            <div class="form-group col-md-6">
                ...
                $status = ['' => '---Select---', '0' => 'Active', '1' => 'In-Active'];
