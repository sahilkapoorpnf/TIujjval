...
<script src="{{asset('public/frontend/js/bootstrap-tagsinput.js')}}" type="text/javascript"></script>
<script src="{{asset('public/frontend/js/bootstrap-tagsinput-angular.min.js')}}" type="text/javascript"></script>
