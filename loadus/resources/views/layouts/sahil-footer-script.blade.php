...
<script type="text/javascript" src="{{asset('public/frontend/js/webslidemenu.js')}}"></script>
<script type="text/javascript" src="{{asset('public/frontend/js/owl.carousel.js')}}"></script>
<script type="text/javascript" src="{{asset('public/frontend/js/pushy.min.js')}}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.js" integrity="sha512-XtmMtDEcNz2j7ekrtHvOVR4iwwaD6o/FUJe6+Zq+HgcCsk3kj4uSQQR8weQ2QVj1o0Pk6PwYLohm206ZzNfubg==" crossorigin="anonymous"></script>

<!-- Own JavaScript File Link -->
<script src="{{asset('public/frontend/san_asset/js/main.js')}}"></script>
