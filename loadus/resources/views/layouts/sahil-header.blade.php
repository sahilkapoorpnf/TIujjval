		...
		<div class="container">
			<div class="menuTop">
				<div class="logo"><a href="{{ url('home') }}">
					<img src="{{asset('public/frontend/img/logo.png')}}" alt="logo"></a>
				</div>
				...
				<div class="navi">
					<ul>
						...
						<li><a href="{{ url('loadus-business') }}" class="<?php echo ($controller == 'UserController' && $action == 'loadus_business') ? 'active' : ''; ?>">Loadus Business</a></li>
