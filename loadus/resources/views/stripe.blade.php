    ...
    <body>
        ...
        <div class="container">
            <div class="login-logo">
                <img src="{{url('public/frontend/img/logo.png')}}" style="margin-bottom:22px">
            </div>
                    ...
                    <div class="panel panel-default credit-card-box">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="alert alert-success text-center">
                                <a href="{{'my-subscription'}}" class="close" data-dismiss="alert" aria-label="close">×</a>
                            ...
                            <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ $strip_key }}" id="payment-form">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <input type="hidden" name="user_email" value="{{$userData[0]->email}}">
                                        <input type="hidden" name="subscription_id" value="{{$subsData[0]->id}}">

                                        <input type="hidden" name="id" value="{{Crypt::encryptString($subsData[0]->id)}}">

                                        
                                        <input type="hidden" name="subscription_type" value="{{$subsData[0]->subscription_type}}">
                                        <input type="hidden" name="subscription_rate" value="{{$subsData[0]->subscription_rate}}">
                                        <input type="hidden" name="description" value="{{$subsData[0]->description}}">
                                        <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now (${{$subsData[0]->subscription_rate}})</button>
                                    </div>
                                </div>
...
window.onload = function () {
    ...
    if (payment_status == 1) {
        ...
        window.setTimeout(function () {
            window.location.href = "{{url('my-subscription')}}";
        }, 3000);
    }
    if (payment_status == 2) {
// redirect after 3 seconds
