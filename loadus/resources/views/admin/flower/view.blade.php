        ...
        <div class="table-responsive">
            <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Flower Unique Id</td>
                        <td>{{$data['group_flower_unique_id']}}</td>
                    </tr>

                    <tr>
                        <td>Flower Owner Name</td>
                ...
                <?php }?>
                    ...
                    <tr>
                        <td>Featured</td>
                        <td>{{($data['is_featured'] == 1) ? 'Featured Flower' : 'Not Featured Flower'}}</td>
                    </tr>
                </tbody>
            ...
            <table id="example1" class="table table-bordered table-striped dataTable">
                <thead>
                    <tr>
                        ...
                        <th style="width: 30%">Flower Member Name</th>
                        <th style="width: 15%">Flower Position Name</th>
    ...
    $(document).ready(function () {
        var group_id = "{{$data['id']}}";
            mytable = $('#example1').DataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "{{url('admin/flower/groupMembers')}}",
                    "type": "POST",
        ...
        $(document).on('click', '.data-member', function () {
            ...
            swal({
                title: "Are you sure?",
                text: "Remove member from flower!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        type: 'POST',
                        url: '{{url("admin/flower/removeMember")}}',
