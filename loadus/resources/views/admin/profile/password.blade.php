...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a  href="<?php echo URL::to('/admin/profile'); ?>" style="float: right"><button class="btn btn-success btn-flat">Back</button></a>
    </div>
</div>
...
<div class="box box-success color-palette-box">
    ...
    <div class="box-body">
        <?php $action = isset($data->id) ? 'admin/profile/passchange' : ''; ?>
