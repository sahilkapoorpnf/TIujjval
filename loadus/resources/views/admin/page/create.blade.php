...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a href="{{url('/admin/page')}}"><button class="btn btn-success btn-flat">Back</button></a>
    </div> 
</div>
@stop
...
<div class="box box-success color-palette-box">
    ...
    <div class="box-body">
        <?php $action = isset($data->id) ? 'admin/page/update/' . Crypt::encryptString($data->id) : 'admin/page/store'; ?>
            ...
            <input type="hidden" name="featured_upload" value="<?php echo isset($data->featured_img) ? $data->featured_img : Input::get('featured_img') ?>">
             ...
             <div class=" col-md-6">
                <div class="form-group">
                    ...
                    <?php echo Form::text('meta_title', isset($data->meta_title) ? $data->meta_title : Input::get('meta_title'), array('class' => 'form-control', 'placeholder' => 'Meta Title')); ?>
                </div>
            </div>
             ...
             <div class=" col-md-6">
                <div class="form-group">
                    ...
                    <?php echo Form::text('meta_description', isset($data->meta_description) ? $data->meta_description : Input::get('meta_description'), array('class' => 'form-control', 'placeholder' => 'Meta Description')); ?>
                </div>
            </div>
             ...
             <div class=" col-md-6">
                <div class="form-group">
                    ...
                    <?php echo Form::text('meta_key', isset($data->meta_key) ? $data->meta_key : Input::get('meta_key'), array('class' => 'form-control', 'placeholder' => 'Meta Key')); ?>
                </div>
            </div>
