...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a href="{{url('admin/categories/add')}}"><button class="btn btn-success btn-flat" data-toggle="tooltip" title="" data-original-title="Create Page">Create Categories</button></a>
    </div> 
</div>
        ...
        <div class="table-responsive">
            <table id="example" class="table table-bordered table-striped dataTable">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{url('admin/sub-categories/'.$category->id)}}" class="btn btn-primary">Sub Categories</a>
