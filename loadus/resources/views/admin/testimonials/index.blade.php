...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a href="{{url('admin/testimonials/create')}}"><button class="btn btn-success btn-flat" data-toggle="tooltip" title="" data-original-title="Create Page">Create Testimonials</button></a>
    </div> 
</div>
