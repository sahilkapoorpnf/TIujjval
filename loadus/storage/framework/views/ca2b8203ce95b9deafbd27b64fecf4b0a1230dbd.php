...
<link rel="stylesheet" href="<?php echo e(asset('public/vendor/adminlte/dist/css/skins/skin-' . config('adminlte.skin', 'blue') . '.min.css')); ?> ">
        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="<?php echo e(url(config('adminlte.dashboard_url', 'dashboard'))); ?>" class="navbar-brand">
                        <?php echo config('adminlte.logo', '<b>LOADUS</b>'); ?>
                ...
                <?php else: ?>
                <!-- Logo -->
                <a href="<?php echo e(url(config('adminlte.dashboard_url', 'dashboard'))); ?>" class="logo">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><?php echo config('adminlte.logo_mini', '<b>A</b>LT'); ?></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><?php echo config('adminlte.logo', '<b>LOADUS</b>ADMIN'); ?></span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?php echo e(asset('public/vendor/adminlte/dist/img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
                                        <?php
                                    }
                                    ?>
...
<script src="<?php echo e(asset('public/vendor/adminlte/bower_components/fastclick/lib/fastclick.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/dist/js/demo.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/bower_components/datatables.net/js/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/vendor/adminlte/dist/chart/highcharts.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/dist/chart/highcharts-3d.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/dist/js/sha256.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/vendor/adminlte/bower_components/select2/dist/js/select2.min.js')); ?>"></script>
<script>
    ...
    $(document).ready(function () {
        $(document).on('change', '#chat_file', function (event) {
            ...
            if (jQuery.inArray(ext, ['gif', 'png', 'jpg', 'jpeg', 'pdf', 'doc']) == -1) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/ajaxfile')); ?>",
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/vendor/adminlte/page.blade.php ENDPATH**/ ?>