		...
		<div class="banner">
			<div class="bannerBox">
				<div class="bannerSearchBox">
					...
					<button class="btn" type="submit"><img src="<?php echo e(asset('public/frontend/san_asset/images/bsearh.png')); ?>"></button>
					</form>
				</div>
				<div class="bannerLocationBox">
					<form action="" class="banSearchBox locactBox">
					<button class="btn" type="submit"><img src="<?php echo e(asset('public/frontend/san_asset/images/blocation.png')); ?>"></button>
					<input class="form-control" type="search" placeholder="All Location" aria-label="Search">
					<button class="btn" type="submit"><img src="<?php echo e(asset('public/frontend/san_asset/images/rlocation.png')); ?>"></button>
					</form>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="bussinesBx">
					<div class="bussinesImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/gyms.jpg')); ?>" alt="">
					</div>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="bussinesBx">
					<div class="bussinesImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/hotel.jpg')); ?>" alt="">
					</div>
					<div class="bussinesTxt">
						<h2>Hotels</h2>
					</div>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="bussinesBx">
					<div class="bussinesImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/cleaning.jpg')); ?>" alt="">
					</div>
					<div class="bussinesTxt">
						<h2>cleaning</h2>
					</div>
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="bussinesBx">
					<div class="bussinesImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/locksmith.jpg')); ?>" alt="">
					</div>
					<div class="bussinesTxt">
						<h2>locksmith</h2>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-12">
				<div class="popularBox">
					<div class="popularImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/piza.jpg')); ?>" alt="">
		...
		<div class="row">
			<div class="col-lg-6 col-sm-12">
				<div class="featureBox">
					...
					<div class="featureImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/feature1.png')); ?>" alt="">
					</div>
			...
			<div class="col-lg-6 col-sm-12">
				<div class="featureBox">
					<div class="offershape">Open</div>
					<div class="featureImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/feature4.png')); ?>" alt="">
					</div>
					<div class="featureArea">
						<div class="featureTop">
							<h2>Wendy's Cafe</h2>
			...
			<div class="col-lg-6 col-sm-12">
				<div class="featureBox">
					<div class="offershape">Open</div>
					<div class="featureImage">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/feature6.png')); ?>" alt="">
					</div>
					<div class="featureArea">
						<div class="featureTop">
							<h2>Burger King</h2>
		...
		<div class="row">
			<div class="col-lg-10 mx-auto col-md-12">
				<div class="appBoxFlex">
					<div class="appBoxA">
						<img src="<?php echo e(asset('public/frontend/san_asset/images/appphn.png')); ?>" alt="">
					</div>
					<div class="appBoxB">
						...
						<div class="appIcons">
							<a href="#"><span><img src="<?php echo e(asset('public/frontend/san_asset/images/appstore.png')); ?>" alt=""></span></a>
							<a href="#"><span><img src="<?php echo e(asset('public/frontend/san_asset/images/googleplay.png')); ?>" alt=""></span></a>
						</div>
						<div class="appMail">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.sahil-base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/frontend/pages/business.blade.php ENDPATH**/ ?>