...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a href="<?php echo e(url('/admin/categories')); ?>"><button class="btn btn-success btn-flat">Back</button></a>
    </div> 
</div>
...
<div class="box box-success color-palette-box">
    ...
    <div class="box-body">
        ...
        <div class="box-body">
            ...
            <img src="<?php echo e(asset('public/sub_categories/'.$userData->icon)); ?>" width="50" height="50">
            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/admin/subcategories/edit.blade.php ENDPATH**/ ?>