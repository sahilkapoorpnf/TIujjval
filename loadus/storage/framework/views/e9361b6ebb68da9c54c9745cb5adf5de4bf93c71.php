    ...
    <div class="container">
        <div class="row d-flex justify-content-sm-between">
            <div class="col-6 col-sm-4 col-md-2 col-lg-2 col-xl-3">
                <div class="logo">
                    <a href="<?php echo e(url('home')); ?>" title=""><img src="<?php echo e(asset('public/frontend/img/logo.png')); ?>" alt="Loadus" /></a>
                </div>
            </div>
                    ...
                    <div class="menu sticky-menu">
                        <nav class="wsmenu clearfix">
                            <ul class="mobile-sub wsmenu-list">
                                ...
                                <!-- <li><a href="<?php echo e(url('about-us')); ?>" class="<?php echo ($controller == 'UserController' && $action == 'about_us') ? 'active' : ''; ?>">About Loadus</a></li> -->
                                ...
                                <li><span class="wsmenu-click"><i class="wsmenu-arrow fa fa-angle-down"></i></span><a href="#">About Loadus</a>
                                    <ul class="wsmenu-submenu">
                                        ...
                                        <li><a href="<?php echo e(url('testimonials')); ?>">Loadus Testimonials</a></li>
                                    </ul>
                                </li>

                                <li><a href="<?php echo e(url('loadus-business')); ?>" class="<?php echo ($controller == 'UserController' && $action == 'loadus_business') ? 'active' : ''; ?>">Loadus Business</a>
                                </li>


                                <!-- <li><a href="<?php echo e(url('contact-us')); ?>" class="<?php echo ($controller == 'UserController' && $action == 'contact_us') ? 'active' : ''; ?>"> Contact Us</a></li> -->
...
<?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/layouts/header.blade.php ENDPATH**/ ?>