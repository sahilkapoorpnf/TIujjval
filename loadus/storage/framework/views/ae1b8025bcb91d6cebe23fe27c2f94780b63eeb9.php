...
<div class="clearfix cbutton">
    <div class="pull-right">
        <a href="<?php echo e(url('Import-Flower-Csv-Sample.csv')); ?>"><button class="btn btn-primary btn-flat fa fa-download csvDemo" data-toggle="tooltip" title="" data-original-title="Flower Csv Sample"></button></a>
        ...
        <a href="<?php echo e(url('Import-Flower-Member-Csv-Sample.csv')); ?>"><button class="btn btn-primary btn-flat fa fa-download csvDemo" data-toggle="tooltip" title="" data-original-title="Flower Member Csv Sample"></button></a>
        ...
        $(document).on('click', '.featured-data', function () {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(url("admin/flower/featured")); ?>',
                        data: {"_token": "<?php echo e(csrf_token()); ?>", id: id},
                        success: function (data) {
                            if (data.status == true) {
                                swal(data.message, {
        ...
        $(document).on('click', '.delete-data', function () {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(url("admin/flower/deletegroup")); ?>',
                        data: {"_token": "<?php echo e(csrf_token()); ?>", id: id},
                        success: function (data) {
                            if (data.status == true) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/admin/flower/index.blade.php ENDPATH**/ ?>