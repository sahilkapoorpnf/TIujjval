                ...
                <div class="dshContent">
                    <div class="row top-panel">
                        ...
                        <aside class="col-lg-5 d-flex tierTp justify-content-end align-items-center">
                            <?php echo e(link_to_action('SubscriptionController@my_subscription','Back', null, array('class' => 'joinBtn'))); ?> 
                        </aside>
                    </div>
                    <div class="Subscription-plan text-center d-sm-flex justify-content-sm-center">
                        ...
                        <div class="plan-box">
                            ...
                            <a class="btn buy-subs" href="<?php echo e(URL('/stripe/'.Crypt::encryptString($subs->id ))); ?>">Buy</a>						
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        
                    </div>
                    <div class="Subscription-plan text-center d-sm-flex justify-content-sm-center">
                        <?php $__currentLoopData = $subscription2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="plan-box">
                            <div class="plan-type">
                                <h3><?php echo e($subscriptionType[$subs->subscription_type]); ?></h3>
                            </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/frontend/subscription/subscription-list.blade.php ENDPATH**/ ?>