...
<section class="slider">
   <div class="home-slider owl-carousel">
      ...
      <div class="item">
         <div class="slide-img">
            <img src="<?php echo asset($banner->banner_image); ?>" alt="" />
         </div>
         <div class="container">
            <div class="slide-content">
               <h1><?php echo $banner->banner_name; ?></h1>
               <p><?php echo $banner->description; ?></p>
               <a class="btn" href="<?php echo e($banner->read_more_link); ?>" target="_blank">Read More</a>
            </div>
         </div>
      </div>
      <!--  item slider 2 -->
      <!-- <div class="item">
         <div class="slide-img">
            <img src="<?php echo e(asset('public/frontend/img/slide01.jpg')); ?>" alt="" />
         </div>
         <div class="container">
            <div class="slide-content">
      ...
      <div class="container">
         <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
               <div class="team-img">
                  <img src="<?php echo e(asset('public/frontend/img/team-img.jpg')); ?>" alt="">
               </div>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
   ...
   <section class="section member">
      <div class="container">
         ...
         <div class="Subscription-plan text-center d-sm-flex justify-content-sm-center">
            ...
            <div class="plan-box">
               <div class="plan-type">
                  <h3><?php echo e($subscriptionType[$val->subscription_type]); ?></h3>
               </div>
               <div class="price">
                  <span>$<?php echo e($val->subscription_rate); ?></span>
               </div>
               <div class="plan-description">
                  <?php echo $val->description; ?>

               </div>
               <a class="btn "href="<?php echo e(url('/stripe/'.Crypt::encryptString($val->id ))); ?>">Buy</a>                  
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/frontend/home.blade.php ENDPATH**/ ?>