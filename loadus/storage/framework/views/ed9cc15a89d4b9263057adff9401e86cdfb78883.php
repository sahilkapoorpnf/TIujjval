            ...
            <div class="row justify-content-center">
               <div class="col-lg-9">
                  <div class="loginBox position-relative">
                     ...
                     <div class="loginForm">
                        <!-- <form id="signUpForm" method="post" class="form" role="form" action="<?php echo e(url('userSignup')); ?>"> -->
                        <form id="signUpForm" method="post" class="form" role="form" action="javascript:void(0)">
                           ...
                           <div class="row">
                              <div class="col-md-12 form-group pb-4">
                                 <div class="d-flex">
                                 <div class="icon"><img src="<?php echo e(asset('public/frontend/img/phone2.png')); ?>"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a18p1ucxu8bf/public_html/TI/TI/TI/loadus/LoadusSourceCode/loadus_laravel/loadus/resources/views/frontend/signup.blade.php ENDPATH**/ ?>