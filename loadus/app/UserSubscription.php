...
class UserSubscription extends Model {
    ...
    public $column_order = array('a.id', 'a.user_id', 'a.subscription_id','a.user_email','a.subscription_rate', 'a.subscription_type','a.created_at', 'a.status');
    public $column_search = array('a.user_id', 'a.subscription_id', 'a.status');
